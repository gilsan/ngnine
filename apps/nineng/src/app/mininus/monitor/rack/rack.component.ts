...
findImg(imgNum) { 
  if (imgNum === 0) {
      return "../../../assets/minimus/imgs/icon_device.png";
  } else if (imgNum === 1) {
      return "../../../assets/minimus/imgs/icon_device1.png";
  } else if (imgNum === 2) {
      return "../../../assets/minimus/imgs/icon_device2.png";
  } else if (imgNum === 3) {
      return "../../../assets/minimus/imgs/icon_device3.png";
  }
}
